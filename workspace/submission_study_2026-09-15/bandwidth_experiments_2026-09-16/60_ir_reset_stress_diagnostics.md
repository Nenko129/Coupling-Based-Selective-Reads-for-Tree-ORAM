...
|---|---:|---:|---:|---:|
| 101 | 1536/1536 | 无 | 0 | 0 |
| 102 | 1535/1536 | 12/32 | 22 | 17 |
| 103 | 1534/1536 | 15/32 | 20 | 0 |
| 104 | 1531/1536 | 28/32 | 21 | 0 |
| 105 | 1535/1536 | 7/32 | 26 | 0 |

12个原失败对应四个种子×三个后端；它们的逻辑续行余量为20–26槽。measurement一列是在新暖机尾部执行后的另一条运行历史，不能称为原始失败运行的实测延迟。原失败收据没有partial-answer摘要；本逻辑模型不能补造该摘要或追认其部分返回正确性。
